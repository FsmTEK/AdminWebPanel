...
<head>
  ...
  <title>Bekir Uyar / Oluştur</title>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p>
                Bekir Uyar - Site admini
                  <small>Bu Tarihten beri (Kasım  2000)</small>
                </p>
              </li>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="../calendar.html">
            ...
            <span class="pull-right-container">
              ...
              <small class="label pull-right bg-blue">09</small>
            </span>
          </a>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Seçenekler</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#"><i class="fa fa-filter"></i> Önemsiz <span class="label label-warning pull-right">65</span></a>
                </li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="https://www.facebook.com/bekirff" target="_Blank"><i class="fa fa-circle-o text-red"></i> İnstagram</a></li>
                <li><a href="https://www.instagram.com/bekirff/?hl=tr " target="_Blank"><i class="fa fa-circle-o text-light-blue"></i> Facebook</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" placeholder="Niçin:">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px">
                      ...
                      <h4>Alt başlık</h4>
                      <p>bir gün adamın teki otobüse binmiş iett ye, elinde ekmek poşeti evine gidiyomuş. 
                        tam bi koltuğa otururken elindeki poşet oralarda oturan bi adama çarpmış. 
                        adam ters ters bakmış, bizimki de demiş ki 
                        "yalan yere yemin etmeseydin sen de" </p>
                      <ul>
                        <li>Liste Öğesi 1  </li>
                        <li>Liste Öğesi 2</li>
                        <li>Liste Öğesi 3</li>
              ...
              <div class="form-group">
                <div class="btn btn-default btn-file">
                  <i class="fa fa-paperclip"></i> Ek Dosya
